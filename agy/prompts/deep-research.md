# Antigravity Deep Research Dossier Prompt
...
If Gemini review is enabled, use `agy/prompts/deep-research-review.md` for review reports and apply the Gate 8.5 review loop from the canonical workflow. If review is being run by the same Antigravity instance, still keep the review as a separate findings report before applying fixes.
